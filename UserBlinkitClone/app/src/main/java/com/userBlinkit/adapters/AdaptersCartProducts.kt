...
import com.userBlinkit.databinding.ItemViewCartProductsBinding
import com.userBlinkit.roomDB.CartProducts

class AdaptersCartProducts : RecyclerView.Adapter<AdaptersCartProducts.CartProductViewHolder>() {
