...
import com.userBlinkit.databinding.ItemViewBestsellerBinding
...
class AdapterBestSellers(val onSeeAllButtonClicked: (Bestseller) -> Unit) : RecyclerView.Adapter<AdapterBestSellers.BestsellerViewHolder>() {
    ...
    val diffUtil = object : DiffUtil.ItemCallback<Bestseller>(){
        ...
        override fun areItemsTheSame(oldItem: Bestseller, newItem: Bestseller, ): Boolean { return oldItem.id == newItem.id }

        override fun areContentsTheSame(oldItem: Bestseller, newItem: Bestseller, ): Boolean { return oldItem == newItem }
    }
